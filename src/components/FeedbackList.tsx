import type { FeedbackRow, TableColumn } from './conversation-body.types'
...
function FeedbackList({ columns, rows }: FeedbackListProps) {
  return (
    <article className="panel table-panel feedback-list">
      <table>
        <thead>
          <tr>
            {columns.map((column) => (
